...
const socialLinks = [
  { name: "Facebook", icon: Facebook, href: "https://www.facebook.com/RTTANTWERP" },
  { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/rtt_commerce/" },
  { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/company/rtt-commerce-bv/posts/?feedView=all" },
];
