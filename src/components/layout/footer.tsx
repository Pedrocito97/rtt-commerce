...
const socialLinks = [
  { name: "Facebook", icon: Facebook, href: "https://www.facebook.com/rttcommerce" },
  { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/rtt_commerce/" },
  { name: "LinkedIn", icon: Linkedin, href: "https://www.linkedin.com/company/rtt-commerce" },
  { name: "TikTok", icon: TikTokIcon, href: "https://www.tiktok.com/@rtt_commerce" },
];
